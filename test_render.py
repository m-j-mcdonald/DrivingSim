...
v = Vehicle(30, 5, 40, 0, is_user=True)
sim.add_vehicle(v)

v.update_xy_theta(6, 40, 0, 1)
v.update_xy_theta(7, 40, 0, 2)
v.update_xy_theta(8, 40, 0, 3)
v.update_xy_theta(9, 40, 0, 4)
v.update_xy_theta(10, 40, 0, 5)
v.update_xy_theta(11, 40, 0, 6)
v.update_xy_theta(12, 40, 0, 7)
v.update_xy_theta(13, 40, 0, 8)
v.update_xy_theta(14, 40, 0, 8)
